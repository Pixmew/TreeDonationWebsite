					...
					<div class="donation-container">
						<div class="donation-box">
							<div class="fields">
								...
								<asp:TextBox ID="firstName" class="firstName" placeholder="First Name" runat="server" Width="150px" BackColor="White" ForeColor="Gray" ></asp:TextBox>
								<asp:TextBox ID="lastName" class="lastName" placeholder="Last Name" runat="server" Width="150px" BackColor="White" ForeColor="Gray" ></asp:TextBox>
								</div>
								<asp:TextBox ID="email" CssClass="email" placeholder="Email" runat="server" BackColor="White" ForeColor="Gray" ></asp:TextBox>
								...
								<asp:TextBox ID="card_number" CssClass="card_number" placeholder="Credit/Debit Card" runat="server" BackColor="White" ForeColor="Gray" ></asp:TextBox>

								<asp:TextBox ID="cvc" CssClass="cvc" placeholder="CVC" runat="server" Width="90px" BackColor="White" ForeColor="Gray" ></asp:TextBox>
								<asp:TextBox ID="zipcode" CssClass="zipcode" placeholder="ZipCode" runat="server" Width="90px" BackColor="White" ForeColor="Gray" ></asp:TextBox>
								<asp:TextBox ID="month" CssClass="month" placeholder="Month" runat="server" Width="90px" BackColor="White" ForeColor="Gray" ></asp:TextBox>	
								<asp:TextBox ID="year" CssClass="year" placeholder="Year" runat="server" Width="90px" BackColor="White" ForeColor="Gray" ></asp:TextBox>
								<br>
								<spam style="font-size:20px;">$</spam>
								<asp:TextBox ID="donate_textbox" CssClass="donate_textbox" placeholder="Donation Amount" runat="server" BackColor="White" ForeColor="Gray" ></asp:TextBox>
							</div>
							<div class="amount">
